...
export default function ReportsPage() {
  ...
  const cats = (inventory?.data as { data?: { categories?: { name: string; count: number }[] } })?.data?.categories ?? [];
  const popularBooks = (popular?.data as { data?: { id: number; title: string; borrowCount: number }[] })?.data ?? [];
